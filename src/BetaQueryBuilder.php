...
class BetaQueryBuilder
{
    ...
    private ?string $unexpectedError = null;
    ...
    public function get(?string $fetchedClass = null): ?object
    {
        if ($this->persist() === null) throw new PDOException($this->unexpectedError, 400);
    ...
    {
        if ($this->prepareQuery() === null) return null;
    ...
    /**
     * Prepare la requete en capturant les potentielles erreurs
     * @return self|null
     */
    private function prepareQuery(): ?self
    {
        try {
            $this->toSQL();
    ...
    public function getAll(?string $fetchedClass = null): ?array
    {
        if ($this->persist() === null) throw new PDOException($this->unexpectedError, 400);
